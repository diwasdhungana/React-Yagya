...
const integrationPoints = [
  ...
  },
  {
    ...
    title: 'AI Algorithms',
    description: 'Developing ethical AI that promotes collaboration and diverse perspectives',
  },
  {
    icon: <Users className="w-5 h-5 text-primary" />,
    title: 'Community',
    description: 'Building features that foster meaningful connections and collective action',
  },
  {
    icon: <ChartBar className="w-5 h-5 text-primary" />,
    title: 'Impact Metrics',
    description: 'Measuring success through the lens of sustainable, positive change',
  },
];
