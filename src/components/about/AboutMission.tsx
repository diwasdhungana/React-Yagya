        ...
        <div className="bg-background rounded-2xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl font-bold text-secondary">Looking Ahead</h3>
              <p className="text-secondary/80 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="p-4 hover:shadow-md transition-shadow">
                <h5 className="font-semibold text-secondary mb-2">Partnerships</h5>
                <p className="text-sm text-secondary/80">
                  Forge meaningful connections for greater impact
                </p>
              </Card>
              <Card className="p-4 hover:shadow-md transition-shadow">
                <h5 className="font-semibold text-secondary mb-2">Innovation</h5>
                <p className="text-sm text-secondary/80">
                  Drive creative solutions to global challenges
                </p>
              </Card>
              <Card className="p-4 hover:shadow-md transition-shadow">
                <h5 className="font-semibold text-secondary mb-2">Scale</h5>
                <p className="text-sm text-secondary/80">
                  Amplify impact through collective action
                </p>
              </Card>
              <Card className="p-4 hover:shadow-md transition-shadow">
                <h5 className="font-semibold text-secondary mb-2">Community</h5>
                <p className="text-sm text-secondary/80">Build lasting relationships for change</p>
              </Card>
            </div>
          </div>
        </div>
