  ...
  return (
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div className="order-2 lg:order-1 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <h4 className="text-xl font-semibold text-foreground mb-2">Modern Adaptation</h4>
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-6 rounded-xl">
            ...
            <h4 className="text-xl font-semibold text-foreground mb-2">United Purpose</h4>
            <p className="text-foreground">
        ...
        <div className="mt-6 md:mt-12">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <h4 className="text-xl font-semibold text-foreground mb-2">Driving Change</h4>
            <p className="text-foreground">
      ...
      <div className="order-1 lg:order-2 space-y-6">
        <h3 className="text-2xl md:text-3xl font-bold text-primary">Philosophical Significance</h3>
